...
<template>
    <div class="hello">
        ...
        <ul>
            <li>
                <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vues/cli-plugin-babel" target="_blank" rel="noopener">babel</a>
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
                <a href="https://forum.vuejs.org" target="_blank" rel="noopene">Forum</a>
            </li>
            <li>
        ...
        <a href="http://www.baidu.com" target="_blank" alt>baidu</a>
    </div>
</template>
